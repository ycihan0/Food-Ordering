...
const UpdateProduct = ({ setIsProductModal, selectedProduct }) => {
  console.log(selectedProduct);
  const [file, setFile] = useState();
  const [imageSrc, setImageSrc] = useState(selectedProduct?.img);
