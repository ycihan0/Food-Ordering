    ...
    <div className="mt-5 mx-4">
      <div className="p-6 bg-secondary text-white rounded-[5px] ">
        ...
        <div className="flex flex-col mt-4">
          <span className="text-lg font-semibold">{comment.reviewer_name}</span>
          <span className="text-[15px]"> {comment.date}</span>
        </div>
      </div>
